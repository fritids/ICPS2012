...
function icps_overview_metafields() {
  return array(icps_cast_ov('gender','SEX'),icps_cast_ov('country', 'Country'), icps_cast_ov('passport_nr', 'Paspoort'), icps_cast_ov('excursion','excursie'),icps_cast_ov('revoke_round', 'Opkanker'));
}
