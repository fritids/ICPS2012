...
require_once 'functions/check-in.php';
...
$form_receipt['meta'] = array('payment_amount', 'gender', 'shirt_size', 'extra_day_pre', 'extra_day_post', 'iaps_member', 'room_number', 'preferred_accommodation');
...
endforeach;
$receiptdata['total_cost'] = icps_full_cost($user_data->ID);
